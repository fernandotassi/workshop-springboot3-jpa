...
{ 
	  ...
	  public void run(String... args) throws Exception 
	  {
		    ...
		    Pedido p1 = new Pedido(null, Instant.parse("2025-06-20T19:53:07Z"), u1);
		    Pedido p2 = new Pedido(null, Instant.parse("2025-07-21T03:42:10Z"), u2);
		    Pedido p3 = new Pedido(null, Instant.parse("2025-07-22T15:21:22Z"), u1);
		    
		    repos.saveAll(Arrays.asList(p1, p2, p3));
	  }
